...
int main( int argc, char **argv ) 
{
    ...
    status &= load_matlab_vector3<double>(s1_points, "ex4a_surface_1.mat" ); 
    status &= load_matlab_vector3<double>(s2_points, "ex4a_surface_2.mat" ); 
    status &= load_matlab_vector3<double>(s3_points, "ex4a_surface_3.mat" ); 
    status &= load_matlab_vector3<double>(sn_points, "ex4a_surface_n.mat" ); 
    ...
    status &= save_matlab_vector3<double>( s1_vlist, "ex4a_s1_vlist.mat" ); 
    status &= save_matlab_vector3<unsigned long int>( s1_flist, "ex4a_s1_flist.mat" ); 

    status &= save_matlab_vector3<double>( s2_vlist, "ex4a_s2_vlist.mat" ); 
    status &= save_matlab_vector3<unsigned long int>( s2_flist, "ex4a_s2_flist.mat" ); 

    status &= save_matlab_vector3<double>( s3_vlist, "ex4a_s3_vlist.mat" ); 
    status &= save_matlab_vector3<unsigned long int>( s3_flist, "ex4a_s3_flist.mat" ); 

    status &= save_matlab_vector3<double>( sn_vlist, "ex4a_sn_vlist.mat" ); 
    status &= save_matlab_vector3<unsigned long int>( sn_flist, "ex4a_sn_flist.mat" ); 

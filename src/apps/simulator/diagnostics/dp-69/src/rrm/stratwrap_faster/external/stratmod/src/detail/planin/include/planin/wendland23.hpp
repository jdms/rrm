...
class Wendland23 : public BasisFunction2D 
{
    public: 
        ...
        double operator()( double x1, double x2 ) const
        {
            ...
            double one_minus_r_8 = (1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r);
            if ( r >= 1 ) { 
                return 0; 
            }
            /* return pow(1-r, 8) * ( 32.0*pow(r, 3) + 25.0*pow(r,2) + 8.0*r + 1.0 ); */
            return one_minus_r_8 * ( 32.0*r*r*r + 25.0*r*r + 8.0*r + 1.0 );
        }
        ...
        double Dx( double x, double y ) const 
        {
            ...
            double one_minus_r_7 = (1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r);
            double val = -1/support_size * ( 352.0 * r*r + 154.0 * r + 22.0 ) * (x/support_size) * one_minus_r_7; //(1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r);
        ...
        double Dy( double x, double y ) const 
        {
            ...
            /* double rminus1to7 = pow(1-r, 7); // */ 
            double one_minus_r_7 = (1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r);
            double val = -1/support_size * ( 352.0 * r*r + 154.0 * r + 22.0 ) * (y/support_size) * one_minus_r_7; //(1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r);
...
/* end */
        double Dxx( double x, double y ) const
        {
            ...
            double one_minus_r_6 = (1-r)*(1-r)*(1-r)*(1-r)*(1-r)*(1-r);

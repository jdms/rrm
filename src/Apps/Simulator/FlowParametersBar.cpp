...
void FlowParametersBar::createDialogs()
{
	...
	/// New GUI ---->
	//// REGION
	connect(spinBox_Number_of_Regions, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, &FlowParametersBar::createRegions);
	...
	//// WELL
	connect(spinBox_Number_of_Wells, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), this, &FlowParametersBar::createWells);
...
int FlowParametersBar::getNumberOfRegions()
{
...
/// New GUI ---->
void FlowParametersBar::newGUIReset()
{
...
void FlowParametersBar::newGUIClear()
{
...
void FlowParametersBar::setRegionPoints(const std::map<int, Eigen::Vector3f>& region_points)
{
...
void FlowParametersBar::setRegionDepth(const float _depth)
{
	this->depth_ = _depth;
...
void FlowParametersBar::getPropertyAreaParameters_new(int& np, std::vector< double >& positions, std::vector< double >& perm, std::vector< double >& poros, std::vector< double >& visc)
{
...
void FlowParametersBar::loadRegions(const int np, const std::vector< double >& positions, const std::vector< double >& perm, const std::vector< double >& poros, const std::vector< double >& visc)
{
	/// Update the GUI
...
void FlowParametersBar::createRegions( )
{
	QStringList l;
...
/// Update the GUI using the current region information
void FlowParametersBar::updateRegionWidget(const int index)
{
...
void FlowParametersBar::loadWells(const int nw, const std::vector< unsigned int >& type, const std::vector< double >& pressure, const std::vector< int >& sign)
{
...
void FlowParametersBar::getWellParameter_new(int& nw, std::vector< unsigned int >& type, std::vector< double >& pressure, std::vector< int >& sign)
{
...
void FlowParametersBar::createWells()
{
	QStringList l;
...
void FlowParametersBar::updateWellsWidget(const int index)
{

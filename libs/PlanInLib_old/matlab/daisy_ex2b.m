...
write_vector3(Surface1, strcat(tmp_dir, '/ex2b_surface_1.mat'));
write_vector3(Surface2, strcat(tmp_dir, '/ex2b_surface_2.mat'));
write_vector3(Surface3, strcat(tmp_dir, '/ex2b_surface_3.mat'));
write_vector3(SurfaceN, strcat(tmp_dir, '/ex2b_surface_n.mat'));
...
[vL1, fL1] = load_patch( strcat(tmp_dir, '/ex2b_s1_vlist.mat'), strcat(tmp_dir, '/ex2b_s1_flist.mat') ); 
fL1 = fL1 + 1;
cL1 = vL1(:,3); 

[vL2, fL2] = load_patch( strcat(tmp_dir, '/ex2b_s2_vlist.mat'), strcat(tmp_dir, '/ex2b_s2_flist.mat') ); 
fL2 = fL2 + 1;
cL2 = vL2(:,3); 

[vL3, fL3] = load_patch( strcat(tmp_dir, '/ex2b_s3_vlist.mat'), strcat(tmp_dir, '/ex2b_s3_flist.mat') ); 
fL3 = fL3 + 1;
cL3 = vL3(:,3); 

[vLN, fLN] = load_patch( strcat(tmp_dir, '/ex2b_sn_vlist.mat'), strcat(tmp_dir, '/ex2b_sn_flist.mat') ); 
fLN = fLN + 1;
cLN = vLN(:,3); 
...
axis equal
axis off
title('Example 2B: remove below Surface_n.') 

...
% Specifies how coarse the curve that describes the channel will be
Channel_Discretization = 64; 

%% Base data structures
build_data_structures

%% Create the canyon's input data (a)
Surface1 = surfacev(Channel_Discretization); 
...
hold on
plot3(Surface1(:,1), Surface1(:,2), Surface1(:,3),'or')

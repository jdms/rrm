...
function [ Points ] = surface2(mean_, position, BaseSurface)
...
% axis off
% axis equal
% title('Input curves for horizon 2 (selected curves in red)'); 

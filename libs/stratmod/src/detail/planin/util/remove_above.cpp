...
int main( int argc, char **argv ) 
{
    ...
    surface.removeAbove(base_surface); 
    ...
    auto face_count = surface.getFaceList(flist); 
    auto t3 = std::chrono::high_resolution_clock::now(); 
    
    auto evaluationtime = std::chrono::duration_cast<std::chrono::milliseconds>( (t3-t2) ).count(); 
    std::cout << "It took " << evaluationtime << " milliseconds to apply rules, and to get: " << face_count << " faces. " << std::endl; 

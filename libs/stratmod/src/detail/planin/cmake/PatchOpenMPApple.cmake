...
if("${APPLE_OMP_AUTOADD}" AND "${CMAKE_CXX_COMPILER_ID}" STREQUAL "AppleClang" AND NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS "9")
    ...
    if(BREW)
        ...
        if(BREW_RESULT_CODE)
            message(STATUS "OpenMP is supported on Mac through Brew. Please run \"brew install cliutils/apple/libomp\"")
        else()
            ...
            set(OpenMP_omp_LIBRARY "${BREW_LIBOMP_PREFIX}/lib/libomp.dylib" CACHE STRING "" FORCE)
            include_directories("${BREW_LIBOMP_PREFIX}/include")
            message(STATUS "Using Homebrew libomp from ${BREW_LIBOMP_PREFIX}")
        endif()
    else()
        message(STATUS "OpenMP is supported on Mac through Homebrew, installing Homebrew is recommmended --> https://brew.sh")
    endif()
endif()

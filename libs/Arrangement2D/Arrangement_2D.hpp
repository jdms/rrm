...
namespace RRM
{
    ...
    class Intersection_cache
    {
        public:
            ...
            Intersection_cache ( Point2D _point , Curve_cache _input_curve , std::size_t _input_curve_index_ , Curve_cache _arr_curve , std::size_t _arr_subcurve_index , std::size_t _arr_index , RELATIVE_POSITION _where )
            {
                this->point_ = _point;

...
# Decide whether to link against 32 or 64 bits libraries
if("${CMAKE_SIZEOF_VOID_P}" STREQUAL "8")
# if(WIN64)
    set(GLEW_BUILD_x64 ON)
endif()
...
macro(GetGLEW2)
    ...
    if (GLEW_BUILD_x64)
        ...
        find_program(GLEW_RUNTIME NAMES glew32.dll HINTS "${GLEW_DIR}/bin/Release/Win32")
    endif()
